...
with System.BB.Board_Support.Cortexm;
with Interfaces;
...
package System.BB.Interrupts is
   ...
   subtype Interrupt_ID is Integer range -1 .. 31;
   --  Interrupt identifier

   subtype HW_Interrupt_ID is Interrupt_ID range 0 .. 31;
   --  Interrupt identifier

   subtype Source_Mode_Type is Interfaces.Unsigned_32;
