...
--        SECOND_CUUID_HALF   => 10);
   ...
   procedure AddressQuestionToMessage(msg : out VN.Communication.CAN.Logic.CAN_Message_Logical; receiver : VN.Communication.CAN.Logic.CAN_Address_Receiver;
                                      sender : VN.Communication.CAN.Logic.CAN_Address_Sender; logicalAddress : VN.Communication.CAN.Logic.Logical_Address; prio : CAN_Message_Prio);

   procedure AddressQuestionFromMessage(msg : VN.Communication.CAN.Logic.CAN_Message_Logical; logicalAddress : out VN.Communication.CAN.Logic.Logical_Address);
   ...
   procedure AddressAnswerToMessage(msg : out VN.Communication.CAN.Logic.CAN_Message_Logical; receiver : VN.Communication.CAN.Logic.CAN_Address_Receiver; sender : VN.Communication.CAN.Logic.CAN_Address_Sender;
                                    CANAddress : VN.Communication.CAN.Logic.CAN_Address_Sender; logicalAddress : VN.Communication.CAN.Logic.Logical_Address; prio : CAN_Message_Prio);
   ...
   procedure AssignLogicalAddressFromMessage(msg : VN.Communication.CAN.Logic.CAN_Message_Logical; logicalAddress : out VN.Communication.CAN.Logic.Logical_Address);

   procedure ComponentTypeToMessage(msg : out VN.Communication.CAN.Logic.CAN_Message_Logical; sender : VN.Communication.CAN.Logic.CAN_Address_Sender; prio : CAN_Message_Prio; isSM_CAN : boolean);

   procedure ComponentTypeFromMessage(msg : VN.Communication.CAN.Logic.CAN_Message_Logical; isSM_CAN : out boolean);

   procedure RequestCUUIDToMessage(msg : out VN.Communication.CAN.Logic.CAN_Message_Logical; sender : VN.Communication.CAN.Logic.CAN_Address_Sender; prio : CAN_Message_Prio);
   ...
   procedure CUUIDHalfFromMessage(msg : VN.Communication.CAN.Logic.CAN_Message_Logical; theCUUID : in out VN.Communication.CAN.Logic.CUUID; firstHalf : Boolean);
...
--                                            sender : out VN.Communication.CAN.Logic.CAN_Address_Sender);
   ...
   procedure StartTransmissionToMessage(msg : out VN.Communication.CAN.Logic.CAN_Message_Logical; receiver : VN.Communication.CAN.Logic.CAN_Address_Receiver;
                                        sender : VN.Communication.CAN.Logic.CAN_Address_Sender; numMessages : Interfaces.Unsigned_16);
   ...
   procedure StartTransmissionFromMessage(msg : VN.Communication.CAN.Logic.CAN_Message_Logical; receiver : out VN.Communication.CAN.Logic.CAN_Address_Receiver;
                                          sender : out VN.Communication.CAN.Logic.CAN_Address_Sender; numMessages : out Interfaces.Unsigned_16);

   procedure AssignCANAddressToMessage(msg : out VN.Communication.CAN.Logic.CAN_Message_Logical;
                                       theUCID : VN.Communication.CAN.Logic.UCID; theCANAddr : VN.Communication.CAN.Logic.CAN_Address_Sender);

   procedure AssignCANAddressFromMessage(msg : VN.Communication.CAN.Logic.CAN_Message_Logical;
                                          theUCID : out VN.Communication.CAN.Logic.UCID; theCANAddr : out VN.Communication.CAN.Logic.CAN_Address_Sender);

   procedure RequestCANAddressToMessage(msg : out VN.Communication.CAN.Logic.CAN_Message_Logical;
                                        theUCID : VN.Communication.CAN.Logic.UCID; bIs_SM_CAN : boolean);

   procedure RequestCANAddressFromMessage(msg : VN.Communication.CAN.Logic.CAN_Message_Logical;
                                          theUCID : out VN.Communication.CAN.Logic.UCID; bIs_SM_CAN : out boolean);

   procedure CANMasterAssignedToMessage(msg : out VN.Communication.CAN.Logic.CAN_Message_Logical; prio : CAN_Message_Prio);
   ...
   function GetMessageID(msgPrio : VN.Communication.CAN.Logic.CAN_Message_Prio; msgType : VN.Communication.CAN.Logic.CAN_Message_Type;
                         receiver : VN.Communication.CAN.Logic.CAN_Address_Receiver; myAddress : VN.Communication.CAN.Logic.CAN_Address_Sender) return VN.Communication.CAN.Logic.CAN_message_ID;

private

   type TwoBytes is array(VN.Communication.CAN.Logic.Byte8'First .. VN.Communication.CAN.Logic.Byte8'First + 1) of Interfaces.Unsigned_8;
   for TwoBytes'Size use 16;

   type FourBytes is array(VN.Communication.CAN.Logic.Byte8'First .. VN.Communication.CAN.Logic.Byte8'First + 3) of Interfaces.Unsigned_8;
   for FourBytes'Size use 32;

   procedure DataToU16(Data : VN.Communication.CAN.Logic.Byte8; u16 : out Interfaces.Unsigned_16);

   procedure U16ToData(u16 : Interfaces.Unsigned_16; Data : out VN.Communication.CAN.Logic.Byte8);
