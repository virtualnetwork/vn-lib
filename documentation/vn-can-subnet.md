...
| 10 | **ComponentType** | Informs the receiver about the sender's type in response to DiscoveryRequest. Sent to CAN address 255 if DiscoveryRequest was sent to address 254 or to the sender of the DiscoveryRequest if it was sent to one's own CAN address. |
