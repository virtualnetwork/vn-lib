 ...
 *
 * SVN $Revision: 5436 $
 * SVN $Date: 2013-03-29 08:42:27 +0530 (Fri, 29 Mar 2013) $
 */
...
)
{
    ...
    if (CAN_SPEED_MANUAL == bitRate)
    {
        ...
        if ((pcan_config->CFG_TSEG2 == 0u) ||
             ((pcan_config->SAMPLING_MODE == 1u) && 
	      (pcan_config->CFG_TSEG2 == 1u)))
        {
...
)
{
    ...
    /* Set abort request */
    this_can->hw_reg->TxMsg[mailbox_number].TXB.TXABORT = ENABLE;
